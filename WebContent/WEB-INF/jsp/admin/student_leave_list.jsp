...
<table class="layui-table" lay-data="{height:471, limit: 10, url:'<%=request.getContextPath() %>/student/select_leave_list.do', where: {userid: '',usertype:'0'}, page:true, id:'idTest'}" lay-filter="demo">
    <thead>
    <tr>
        ...
        '
            ...
            refreshEvaluation: function(){
                table.reload('idTest', {
                    ...
                    ,where: {userid: '',usertype:'0'} //设定异步数据接口的额外参数
                });
            },
