...
<table class="layui-table"
       lay-data="{height:471, limit: 10, url:'<%=request.getContextPath() %>/admin/select_student_list.do', page:true, id:'idTest'}"
       lay-filter="demo">
    <thead>
    <tr>
        <th lay-data="{field:'id', width:1000, sort: true, fixed: true}">ID</th>
        ...
        <th lay-data="{field:'departmentname', width:250, sort: true}">学院</th>
