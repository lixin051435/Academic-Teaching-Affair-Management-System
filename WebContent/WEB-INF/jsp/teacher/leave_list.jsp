...
<table class="layui-table" lay-data="{height:471, limit: 10, url:'<%=request.getContextPath() %>/teacher/select_leave_list.do', where: {userid: '${id }',usertype:'1'}, page:true, id:'idTest'}" lay-filter="demo">
  <thead>
  <tr>
        ...
        '
            ...
            refreshEvaluation: function(){
                table.reload('idTest', {
                    ...
                    ,where: {userid: '${id }',usertype:'1'} //设定异步数据接口的额外参数
                });
            },
