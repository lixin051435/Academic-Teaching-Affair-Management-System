    ...
    <style type="text/css">
        * {
        ...
        body {
            font-family: "微软雅黑";
            font-size: 14px;
            background: url(<%=request.getContextPath() %>/static/login/123.jgp) fixed center center;
        }
...
<div class="logo_box">
    ...
    <form action="<%=request.getContextPath() %>/index.do" name="f" method="post">
        <div class="input_outer">
            ...
            <input name="id" class="text" onFocus=" if(this.value=='输入ID或用户名登录') this.value=''"
        ...
        <div class="mb2"><a class="act-but submit" href="javascript:$('form').submit();" style="color: #FFFFFF">登录</a>
        </div>
        <span>${msg }</span>
    </form>
