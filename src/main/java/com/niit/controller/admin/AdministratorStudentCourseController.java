...
public class AdministratorStudentCourseController {
    ...
    public String updateStudentCourse(StudentCourse studentCourse, HttpServletResponse response) throws Exception {
        ...
        TeacherCourse teacherCourse = teacherCourseService.findByCourseId(studentCourse.getCourseId());
        String term = teacherCourse.getTerm();
        Evaluation evaluation = new Evaluation();
        evaluation.setCourseId(studentCourse.getCourseId());
        evaluation.setStudentId(studentCourse.getStudentId());
    ...
    public String insertStudentCourse(StudentCourse studentCourse, HttpServletResponse response) throws Exception {
        ...
        score.setStudentId(studentCourse.getStudentId());
        score.setCourseId(studentCourse.getCourseId());
        score.setScore("0");
        score.setTerm(studentCourse.getTerm());
